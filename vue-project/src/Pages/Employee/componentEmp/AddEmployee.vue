                ...
                <v-container grid-list-md>
                  <v-layout wrap>
                    <v-flex xs6>
                       ...
                       <v-text-field label="Username" :rules="usernameRules" v-model="employee.empUsername"></v-text-field>
                    ...
                    <v-flex xs6>
                      ...
                      <v-text-field label="Password" :rules="passwordRules" type="password" v-model="employee.empPassword"></v-text-field>
                      <v-text-field label="Phone" :rules="phoneRules"  mask="### ### ####" v-model="employee.empPhone"></v-text-field>
                    </v-flex>
                  </v-layout>
                </v-container>
               </v-form>
...
export default { 
  ...
  created(){
    axios.get("http://localhost:3000/api/getallposition/"+1).then(response => {
    ...
    confirmAdd(){ 
      if(this.$refs.form.validate()){
       var a={
          ...
          empPosition: this.selectedPosition,
       }
       console.log(a);
       this.dialog= false; 
       this.refreshAccount();

            ...
            <v-dialog v-model="dialog" max-width="490">
              <v-card>
                <v-card-text class="headline">
                  ...
                  <v-col ><v-text-field label="BillId"></v-text-field></v-col>
                  <v-col cols="12" sm="6" md="3"><v-text-field label="TotalPrice"></v-text-field></v-col>
                  <v-col cols="12" sm="6" md="3"><v-text-field label="EatTimeStart"></v-text-field></v-col>
                  <v-col cols="12" sm="6" md="3"><v-text-field label="EatTimeEnd"></v-text-field></v-col>
                  <v-col cols="12" sm="6" md="3"><v-text-field label="TableNumber"></v-text-field></v-col>
                  <v-col cols="12" sm="6" md="3"><v-text-field label="NumOfCust"></v-text-field></v-col>
                  <v-col cols="12" sm="6" md="3"><v-text-field label="TypeId"></v-text-field></v-col>

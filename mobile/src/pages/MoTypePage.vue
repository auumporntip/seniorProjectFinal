...
export default {
  ...
  methods: {
    ...
    clickNext() {
      ...
      if (this.$refs.form.validate()) {
        axios
          .post("http://ec2-54-169-124-227.ap-southeast-1.compute.amazonaws.com:3000/api/insertbill", {
            totalPrice: 0,
            eatTimeEnd: new Date(),
  ...
  created() {
    ...
    axios
      .get("http://ec2-54-169-124-227.ap-southeast-1.compute.amazonaws.com:3000/api/gettypeofservice/" + 1)
      .then(response => {

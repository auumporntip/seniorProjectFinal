  ...
  created() {
    ...
    if (JSON.parse(sessionStorage.getItem("foodMenu")) != null) {
      ...
      if (this.typeOfService.typePrice != null) {
        axios
          .get(
            "http://3.0.183.80:3000/api/getmenubytypeofserviceid/" +
        ...
        axios
          .get("http://3.0.183.80:3000/api/getallmenu/" + 1)
          .then(response => {
            this.foodMenu = response.data;
            this.foodMenu.forEach(element => {
              element.amount = 0;
    ...
    axios.get("http://3.0.183.80:3000/api/getcategory/" + 1).then(response => {

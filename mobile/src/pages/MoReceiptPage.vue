...
export default {
  ...
  methods: {
    okDialog() {
      axios
        .post("http://ec2-54-169-124-227.ap-southeast-1.compute.amazonaws.com:3000/api/insertnotification", {
  ...
  created() {
    ...
    axios
      .get("http://ec2-54-169-124-227.ap-southeast-1.compute.amazonaws.com:3000/api/getbillbybillid/" + id)
      .then(response => {
